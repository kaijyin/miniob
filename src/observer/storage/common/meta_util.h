...
static constexpr const char *TABLE_META_FILE_COMPRESS_PATTERN = ".*\\.table.compress$";
static constexpr const char *TABLE_DATA_SUFFIX = ".data";
static constexpr const char *TABLE_DATA_STR_SUFFIX = ".data.str";
static constexpr const char *TABLE_INDEX_SUFFIX = ".index";
static constexpr const char *TABLE_HUF_SUFFIX = ".huf";
...
std::string table_str_data_file(const char *base_dir, const char *table_name);
std::string table_index_file(const char *base_dir, const char *table_name, const char *index_name);
std::string table_huf_file(const char *base_dir, const char *table_name);
